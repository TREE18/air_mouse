...
void ANBT_I2C_Configuration(void)			
{
  ...
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;   //圆点博士:设置I2C口最大允许输出速度
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;	  //圆点博士:设置I2C为浮空输入
...
void ANBT_I2C_SendACK(void)       //应答信号
{
 	ANBT_I2C_SDA_0;
 	ANBT_I2C_NOP;
 	ANBT_I2C_SCL_1;
...
void ANBT_I2C_SendNACK(void)       //无应答信号
{
	ANBT_I2C_SDA_1;
	ANBT_I2C_NOP;
	ANBT_I2C_SCL_1;
