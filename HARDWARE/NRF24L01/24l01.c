...
{ 	
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOA, ENABLE);	 //使能PB,D,G端口时钟
    	


	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2|GPIO_Pin_4;	//PG6 7 推挽 
	...
	GPIO_ResetBits(GPIOA,GPIO_Pin_2|GPIO_Pin_3|GPIO_Pin_4);//PG6,7,8上拉					 
...
void NRF24L01_RX_Mode(void)
{
	NRF24L01_CE=0;	  
  	...
  	NRF24L01_Write_Reg(WRITE_REG_NRF+RF_SETUP,0x27);//设置TX发射参数,0db增益,2Mbps,低噪声增益开启   
